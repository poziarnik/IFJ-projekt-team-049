...
int fc_returnParams(Token* MyToken, symtable* mySymtable, ASTtree* abstractTree);
int fc_returnParam(Token* MyToken, symtable* mySymtable, ASTtree* abstractTree);
int fc_returnNextParam(Token* MyToken, symtable* mySymtable, ASTtree* abstractTree);
